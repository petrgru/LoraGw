...
struct pins {
	uint8_t dio0=26;	// GPIO15 / D8. For the Hallard board shared between DIO0/DIO1/DIO2
	uint8_t dio1=26;	// GPIO15 / D8. Used for CAD, may or not be shared with DIO0
	uint8_t dio2=26;	// GPIO15 / D8. Used for frequency hopping, don't care
	uint8_t ss=18;		// GPIO16 / D0. Select pin connected to GPIO16 / D0
